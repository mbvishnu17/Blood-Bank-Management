...
<title>View all Blood Stocks</title>
</head>
																...
																<tbody style="">
																	<tr style="background-color: red">
																		<td width="11%" height="33" align="center"
																			...
																			style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">Blood Group</span></td>
																		<td width="16%" align="center" valign="middle"
																			style="color: white"><span
																			style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">Count</span></td>
																	...
																	%>
																	<tr>
																		<td align="center" valign="middle" colspan="7" style="color: red; font-weight: bold;">No Blood Stock Details Found</td>
																	</tr>
																	<%
																		}
																	%>
