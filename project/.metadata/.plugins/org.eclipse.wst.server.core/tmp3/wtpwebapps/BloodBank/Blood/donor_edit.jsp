...
<body>
  ...
  %><%--=message --%>
	...
	<div class="container">
		<form action="donor_edit_process.jsp" onsubmit="return validate();">
	...
	-->
			...
			<input type="text" id="txtDonorName" name="txtDonorName"
			...
			<input type="radio" name="gender" id="txtgender" value="Male" checked>Male <input
				type="radio" name="gender" id="txtgender" value="Female">Female<br> <br>
			<br> <label for="dob">Age</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" id="txtage" name="age" value="<%=sage%>"><br>
			<br> <label for="phone">Contact No:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" id="txtPhone" name="txtPhone" placeholder="Contact Number should be a 10 digit number"
				value="<%=phone%>"><br> <br> 
           ...
           <label for="height">Height</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" id="txtHeight" name="txtHeight" value="<%=height%>"placeholder="Your height is..." required><br> <br>
			<label for="weight">Weight</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" id="txtWeight" name="txtWeight" value="<%=weight%>"
