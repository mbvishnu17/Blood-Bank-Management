												...
												<tr>
													<td height="33" align="center" valign="middle">
														<form id="form1" name="form1" method="post">
															<%
																ArrayList<AdminReleaseReceiverDTO> releases = AdminReleaseReceiverBL.getReleases();
															...
															<table width="95%" border="1" align="center"
																...
																<tbody style="">
																	...
																	<%
																		for (AdminReleaseReceiverDTO release : releases) {
																	%>
																	<tr>
																		...
																		<td align="center" valign="middle"
																			style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">&nbsp;<%=release.getGender()%></td>
																	...
																	%>
																	<tr>
																		<td align="center" valign="middle" colspan="7" style="color: red; font-weight: bold;">No Blood Released
																			Details Found</td>
																	</tr>
																	<%
																		}
