																...
																<tbody style="">
																	...
																	<tr>
																		...
																		<td align="center" valign="middle"
																			style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">&nbsp;<%=receiver.getGender()%></td>
																	...
																	<tr>
																		<td valign="middle" colspan="7" align="center"
																			style="color: red; font-weight: bold;">No
																			receiver Details Found</td>
																	</tr>
																	<%
																		}
																	%>
