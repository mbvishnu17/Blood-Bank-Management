...
<html>
<head>
<script src="../includes/validation2.js"></script>
...
<body>
	...
	<div style="background-image: url('images/logo2.jpg')">
		...
		<div class="container">
			<form action="receiver_add_process.jsp" onsubmit="return validate();">
				...
				<input type="text" id="txtHosName" name="txtHosName"
					placeholder="Your hospital name is..."><br>
				<br> <label for="hos_id">Hospital Patient ID</label> <input
					type="text" id="txtHosPatID" name="txtHosPatID"
					placeholder="Your hospital patient id is.."><br>
				<br> <label for="phone">Contact No:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="text" id="txtPhone" name="txtPhone"
					placeholder="Your contact no is.."><br>
